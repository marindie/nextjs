...
const Header = () => {
  ...
  return (
    <header className={css.cssGroup + 'header'}>
      <div
        className={css.cssGroup + 'head_logo'}
        style={{
      ...
      <div className={css.cssGroup + 'container'}>
		...
		'
          ...
          <div className={css.cssGroup + 'header_menus ' + css.cssGroup + 'column'}>
            <div className={css.cssGroup + 'columns'}>
              <ul
                id='bvheader-navigation'
                className={css.cssGroup + 'navigation ' + css.cssGroup + 'column'}
              >
                <li
                  id='menu-item-8827'
                  className={css.cssGroup + 'navigation_item'}
                >
                  <a href='/products/'>Platform</a>
                  <ul className={css.cssGroup + 'navigation_submenu'}>
                    <li
                      id='menu-item-37430'
                      className={css.cssGroup + 'navigation_submenu_item'}
                    >
                      <a href='#'>0th</a>
                      <ul className={css.cssGroup + 'submenu_item_menu'}>
                        <li
                          id='menu-item-37432'
                  ...
                  <ul className={css.cssGroup + 'navigation_submenu'}>
                    ...
                    >
                      <a href='https://www.bazaarvoice.com/industries/apparel-accessories/'>
                        Apparel &amp; Accessories
                        <div className='bvheader-navigation__item-description'>
                          Bring the in-store retail shopping experience to your site with inspiring
                          imagery from customers.
                        </div>
                      </a>
                    </li>
                    <li
                    ...
                    >
                      <a href='https://www.bazaarvoice.com/industries/consumer-electronics/'>
                        ...
                        <div className='bvheader-navigation__item-description'>
                          Provide informative product content at every touchpoint—from discovery to
                          purchase.
                        </div>
                      </a>
                    </li>
                    ...
                    >
                      <a href='https://www.bazaarvoice.com/industries/food-beverage/'>
                        Food &amp; Beverage
                        <div className='bvheader-navigation__item-description'>
                          Easily sample new products and keep product pages fresh with new reviews.
                        </div>
                      </a>
                    </li>
                    <li
                  ...
                  <ul className={css.cssGroup + 'navigation_submenu'}>
                    ...
                    >
                      <a href='/blog/'>
                        Blog
                        <div className='bvheader-navigation__item-description'>
                          Strategies, research, and industry trends – your pulse on the marketplace.{' '}
                        </div>
                      </a>
                      <ul className='sub-menu bvheader-navigation__submenu'>
                        <li
                          ...
                          <ul className='sub-menu bvheader-navigation__submenu'>
                            ...
                            >
                              <a href='https://www.bazaarvoice.com/company/'>
                                About Bazaarvoice
                                <div className='bvheader-navigation__item-description'>
                                  Bazaarvoice brings a people-first approach to advanced technology,
                                  connecting thousands of brands and retailers to the voices of
                                  their customers.
                                </div>
                              </a>
                              <ul className='sub-menu bvheader-navigation__submenu'>
                                ...
                                >
                                  <a href='https://www.bazaarvoice.com/company/careers/'>Careers</a>
                                </li>
                                <li
                                  id='menu-item-21160'
                          ...
                          <ul className='sub-menu bvheader-navigation__submenu'>
                            ...
                            >
                              <a href='https://www.bazaarvoice.com/company/trust/'>
                                Trust
                                <div className='bvheader-navigation__item-description'>
                                  Security, privacy, and compliance are baked into everything we do.
                                </div>
                              </a>
                            </li>
                          </ul>
          ...
          <button
            className={css.cssGroup + 'hamburger'}
